...
#include "RTSPlayerSpectatorCameraPawn.generated.h"

/**
 * 
 */
UCLASS()
class HONOURSPROJECTUNREAL_API ARTSPlayerSpectatorCameraPawn : public ASpectatorPawn
{
	GENERATED_BODY()
...
public:
	...
	ARTSPlayerSpectatorCameraPawn(const FObjectInitializer& ObjectInitializer);
...
private:
	...
	void SetupPlayerInputComponent(class UInputComonent* InputComponent);
