...
#include "RTSPlayerCameraPawn.generated.h"

UCLASS()
class HONOURSPROJECTUNREAL_API ARTSPlayerCameraPawn : public APawn
{
	GENERATED_BODY()

public:
	// Sets default values for this pawn's properties
	ARTSPlayerCameraPawn(const FObjectInitializer& ObjectInitializer);
